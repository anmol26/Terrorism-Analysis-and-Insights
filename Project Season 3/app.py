# -*- coding: utf-8 -*-
"""
Created on Mon Aug 24 00:53:24 2020
...
#global variable
app= dash.Dash(__name__,external_stylesheets=external_stylesheets)  #creating your object
...
def load_data():
    ...
    #dropdown takes data in array dictionary. so we create month_list,country_list,...... 
...
def create_app_ui():
    #to change fevicon just create "assets" folder inside project season 3(directory)
    #and save your fevicon there with name as "fevicon.ico". no need to write
    #any code for adding fevicon. just create folder inside directory.
    #use www.fevicon.cc website for generate fevicons
    main_layout=html.Div(
        [
            html.Div([
                html.H1(id='Main_title',children='Terrorism Analysis with Insights',className='h1'),
                html.Img(src='/assets/icon-forsk.png'),
                html.Img(src='/assets/anmol.jpg')
                ],className='banner'),
            dcc.Tabs(id='Tabs', value='tab-1', children=[
                dcc.Tab(label='Map Tool', id='Map-tool', value='tab-1', children=[
                    ...
                    html.Br(),
                    html.Br(),
                    html.Center(html.H6(children='Select The Year',className='h6',style={'color':'Black'})),
                    dcc.RangeSlider(id='year-slider',
                        ...
                        ,style={'background-image':'url("/assets/backimg.jpg")','background-repeat': 'no-repeat','background-size': '100% 100%'})]),
...
#main function
def main():
    print("Welcome to my project of Terrorism Analysis")
    load_data()
    open_browser()
    global app
    ...
    #for best industry practices we assign none to our global variables in
    #the end of program
    df=None
    app=None
